...
/* package my-grep-0.1.0.0 */
#ifndef VERSION_my_grep
#define VERSION_my_grep "0.1.0.0"
#endif /* VERSION_my_grep */
#ifndef MIN_VERSION_my_grep
#define MIN_VERSION_my_grep(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_grep */
...
/* package safe-coloured-text-0.3.0.1 */
#ifndef VERSION_safe_coloured_text
#define VERSION_safe_coloured_text "0.3.0.1"
#endif /* VERSION_safe_coloured_text */
#ifndef MIN_VERSION_safe_coloured_text
#define MIN_VERSION_safe_coloured_text(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 0)
#endif /* MIN_VERSION_safe_coloured_text */
/* package text-2.0.2 */
#ifndef VERSION_text
...
#define CURRENT_PACKAGE_KEY "my-grep-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "my-grep-0.1.0.0-inplace"
